...
function frame(now) {
  ...
  // play authored cinematic shots for a few beats (the binding of Isaac...)
  const cineFov = director.cinematic(d, camPos, lookPos);
  ...
  const wantFov = baseFov + mood.fov + fx.fovAdd + beholdFov + cineFov;
